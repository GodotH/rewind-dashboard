---
name: investigate
description: Investigate a URL or page using agent-browser
user_invocable: true
arguments:
  - name: url
...
You are investigating **$ARGUMENTS.url** using agent-browser.
...
- Check `agent-browser console` for errors
...
## Notes
- Use `agent-browser`, not the older browser tooling
