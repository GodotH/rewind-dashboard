...
async function scanCodexProjects(): Promise<ProjectInfo[]> {
...
async function scanGeminiProjects(): Promise<ProjectInfo[]> {
...
export async function scanProjects(): Promise<ProjectInfo[]> {
  const claude = await scanClaudeProjects()
  const codex = await scanCodexProjects()
  const gemini = await scanGeminiProjects()
